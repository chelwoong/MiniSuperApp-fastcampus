...
final class AddPaymentMethodViewController: UIViewController, AddPaymentMethodPresentable, AddPaymentMethodViewControllable {
    ...
    init(closeButtonType: DismissButtonType) {
        ...
        self.setupViews()
        self.setupNavigationItem(with: closeButtonType, target: self, action: #selector(didTapClose))
    }
    ...
    required init?(coder: NSCoder) {
        ...
        self.setupViews()
        self.setupNavigationItem(with: .close, target: self, action: #selector(didTapClose))
    }

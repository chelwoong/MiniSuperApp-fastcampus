...
class AddPaymentMethodIntegrationTests: XCTestCase {
    ...
    private var repository: CardOnFileRepositoryMock {
        return self.dependency.cardOnFileRepository as! CardOnFileRepositoryMock
    }
    ...
    override func setUpWithError() throws {
        ...
        self.eventGenerator = try EventGenerator(viewController: navigation.navigationController)
    ...
    func testAddPaymentMethod() throws {
        ...
        try eventGenerator.keyType("123124123123123")
        ...
        try eventGenerator.keyType("121")
